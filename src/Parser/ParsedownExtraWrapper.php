<?php
/**
 * Parsedown Extra Wrapper class.
 *
 * Wraps the ParsedownExtra class to implement our interface.
 *
 * @package CrispyTheme
 * @since 1.0.0
 */
 ...
 * Parsedown Extra Wrapper class.
 */
class ParsedownExtraWrapper implements ParserInterface {
	 ...
	 * Constructor.
	 *
	 * @param ParsedownExtra $parsedown The ParsedownExtra instance.
	 */
